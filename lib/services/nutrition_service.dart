// ============================================================================
// nutrition_service.dart — ⚠️ DEAD CODE (ไม่ถูก import ที่ไหนเลย)
// ----------------------------------------------------------------------------
// service เก่าที่ค้น OpenFoodFacts จากชื่ออาหาร (เหมือน api_service.dart)
// ปัจจุบันใช้ Gemini แทนทั้งหมด

// ============================================================================
// app_theme.dart — ⚠️ DEAD CODE (ไม่ถูก import ที่ไหนเลย)
// ----------------------------------------------------------------------------
// ธีมเก่าก่อน UI overhaul (cosmic) — เก็บไว้เผื่อย้อนกลับ
// ปัจจุบันใช้ _buildTheme() ใน main.dart แทน (ผูกกับ TimeThemeController)
